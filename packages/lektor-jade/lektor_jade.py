...
class JadeTemplatePlugin(Plugin):
    ...
    def on_setup_env(self, **extra):
        ...
        webasset_env.register('css_bundle', Bundle(
            ...
            "_css/indypy/indypy.css",
            "_css/indypy/tito.css",
            "_css/indypy/content.css",
            "_css/indypy/home.css",
            "_css/indypy/news.css",
            "_css/indypy/about.css",
            "_css/indypy/venue.css",
            "_css/indypy/tickets.css",
            "_css/indypy/speakers.css",
            "_css/indypy/sponsors.css",
            "_css/indypy/talks.css",
            filters = 'cssmin',
            output = "css/indypy.css",
        ))
